...
public class AbilityFactory : MonoBehaviour
{
    ...
    public static BasicAbilityForm InstantiateBasicWorldAbility(BasicAbility abilityToBeCreated, Vector3 locationToBePlaced, Guid unitCreating, RootEntity.EntityType entityType, RootAbility.CreationMethod creation, AbilityChaperone abilityChaperone)
    {
    ...
    public static UniqueAbilityForm InstantiateUniqueWorldAbility(UniqueAbility abilityToBeCreated, Vector3 locationToBePlaced, Guid unitCreating, RootEntity.EntityType entityType, RootAbility.CreationMethod creation, AbilityChaperone abilityChaperone)
    {
        if (AbilityFolder == null)
            AbilityFolder = GameObject.Find("AbilityFolder").transform;
