...
public class HandEquipmentBases
{
    ...
    {
        T1_Hand.slotType = EquipmentSlot.SlotType.Hand;
        T1_Hand.itemName = "T1 Gauntlet";
        T1_Hand.itemDescription = "T1 Gauntlet";
        T1_Hand.itemImageLocation = string.Format("Items/Equipment/{0}/BasicGauntlet/BasicGauntlet", T1_Hand.slotType);
        T1_Hand.dropWeight = 1000;

        T2_Hand.slotType = EquipmentSlot.SlotType.Hand;
        T2_Hand.itemName = "T2 Gauntlet";
        T2_Hand.itemDescription = "T2 Gauntlet";
        T2_Hand.itemImageLocation = string.Format("Items/Equipment/{0}/BasicGauntlet/BasicGauntlet", T2_Hand.slotType);
        T1_Hand.dropWeight = 1000;

        T3_Hand.slotType = EquipmentSlot.SlotType.Hand;
        T3_Hand.itemName = "T3 Gauntlet";
        T3_Hand.itemDescription = "T3 Gauntlet";
        T3_Hand.itemImageLocation = string.Format("Items/Equipment/{0}/BasicGauntlet/BasicGauntlet", T3_Hand.slotType);
        T1_Hand.dropWeight = 1000;

        T4_Hand.slotType = EquipmentSlot.SlotType.Hand;
        T4_Hand.itemName = "T4 Gauntlet";
        T4_Hand.itemDescription = "T4 Gauntlet";
        T4_Hand.itemImageLocation = string.Format("Items/Equipment/{0}/BasicGauntlet/BasicGauntlet", T4_Hand.slotType);
        T1_Hand.dropWeight = 1000;
    }
