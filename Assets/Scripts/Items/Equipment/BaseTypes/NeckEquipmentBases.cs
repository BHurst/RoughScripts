...
public class NeckEquipmentBases : MonoBehaviour
{
    ...
    {
        T1_Neck.fitsInSlot = EquipmentInventoryItem.EquipmentSlot.Neck;
        T1_Neck.itemName = "T1 Amulet";
        T1_Neck.itemDescription = "T1 Amulet";
        T1_Neck.itemImageLocation = string.Format("Items/Equipment/{0}/BasicAmulet/BasicAmulet", T1_Neck.fitsInSlot);
        T1_Neck.dropWeight = 1000;

        T2_Neck.fitsInSlot = EquipmentInventoryItem.EquipmentSlot.Neck;
        T2_Neck.itemName = "T2 Amulet";
        T2_Neck.itemDescription = "T2 Amulet";
        T2_Neck.itemImageLocation = string.Format("Items/Equipment/{0}/BasicAmulet/BasicAmulet", T2_Neck.fitsInSlot);
        T1_Neck.dropWeight = 1000;

        T3_Neck.fitsInSlot = EquipmentInventoryItem.EquipmentSlot.Neck;
        T3_Neck.itemName = "T3 Amulet";
        T3_Neck.itemDescription = "T3 Amulet";
        T3_Neck.itemImageLocation = string.Format("Items/Equipment/{0}/BasicAmulet/BasicAmulet", T3_Neck.fitsInSlot);
        T1_Neck.dropWeight = 1000;

        T4_Neck.fitsInSlot = EquipmentInventoryItem.EquipmentSlot.Neck;
        T4_Neck.itemName = "T4 Amulet";
        T4_Neck.itemDescription = "T4 Amulet";
        T4_Neck.itemImageLocation = string.Format("Items/Equipment/{0}/BasicAmulet/BasicAmulet", T4_Neck.fitsInSlot);
        T1_Neck.dropWeight = 1000;
    }
