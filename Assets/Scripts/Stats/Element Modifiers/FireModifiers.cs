...
public class FireModifiers
{
    List<ModifierGroup> Fire_Modifiers = new List<ModifierGroup>()
    {
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Damage, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .10f, RangeHigh = .14f, DropWeight = 900,
            availableOn = new (){ EquipmentSlot.SlotType.Back,
                EquipmentSlot.SlotType.Hand,
                EquipmentSlot.SlotType.Neck,
                EquipmentSlot.SlotType.Weapon
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Damage, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .15f, RangeHigh = .19f, DropWeight = 800,
            availableOn = new (){ EquipmentSlot.SlotType.Back,
                EquipmentSlot.SlotType.Hand,
                EquipmentSlot.SlotType.Neck,
                EquipmentSlot.SlotType.Weapon
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Damage, Method = ModifierGroup.EMethod.MultiplyPercent, RangeLow = .05f, RangeHigh = .07f, DropWeight = 900,
            availableOn = new (){ EquipmentSlot.SlotType.Back,
                EquipmentSlot.SlotType.Hand,
                EquipmentSlot.SlotType.Neck,
                EquipmentSlot.SlotType.Weapon
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Damage, Method = ModifierGroup.EMethod.MultiplyPercent, RangeLow = .08f, RangeHigh = .10f, DropWeight = 800,
            availableOn = new (){ EquipmentSlot.SlotType.Back,
                EquipmentSlot.SlotType.Hand,
                EquipmentSlot.SlotType.Neck,
                EquipmentSlot.SlotType.Weapon
        ...
        //Defensive
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Resistance, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .02f, RangeHigh = .04f, DropWeight = 1000,
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Resistance, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .05f, RangeHigh = .07f, DropWeight = 900,
            availableOn = new (){ EquipmentSlot.SlotType.Arm,
                EquipmentSlot.SlotType.Chest,
                EquipmentSlot.SlotType.Foot,
                EquipmentSlot.SlotType.Head,
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Resistance, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .08f, RangeHigh = .10f, DropWeight = 800,
            availableOn = new (){ EquipmentSlot.SlotType.Arm,
                EquipmentSlot.SlotType.Chest,
                EquipmentSlot.SlotType.Foot,
                EquipmentSlot.SlotType.Head,
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Resistance, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .11f, RangeHigh = .13f, DropWeight = 700,
            availableOn = new (){ EquipmentSlot.SlotType.Arm,
                EquipmentSlot.SlotType.Chest,
                EquipmentSlot.SlotType.Foot,
                EquipmentSlot.SlotType.Head,
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Resistance, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .14f, RangeHigh = .16f, DropWeight = 600,
            availableOn = new (){ EquipmentSlot.SlotType.Arm,
                EquipmentSlot.SlotType.Chest,
                EquipmentSlot.SlotType.Foot,
                EquipmentSlot.SlotType.Head,
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Resistance, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .17f, RangeHigh = .19f, DropWeight = 500,
            availableOn = new (){ EquipmentSlot.SlotType.Arm,
                EquipmentSlot.SlotType.Chest,
                EquipmentSlot.SlotType.Foot,
                EquipmentSlot.SlotType.Head,
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Resistance, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .20f, RangeHigh = .22f, DropWeight = 400,
            availableOn = new (){ EquipmentSlot.SlotType.Arm,
                EquipmentSlot.SlotType.Chest,
                EquipmentSlot.SlotType.Foot,
                EquipmentSlot.SlotType.Head,
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Resistance, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .23f, RangeHigh = .25f, DropWeight = 300,
            availableOn = new (){ EquipmentSlot.SlotType.Arm,
                EquipmentSlot.SlotType.Chest,
                EquipmentSlot.SlotType.Foot,
                EquipmentSlot.SlotType.Head,
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Resistance, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .26f, RangeHigh = .28f, DropWeight = 200,
            availableOn = new (){ EquipmentSlot.SlotType.Arm,
                EquipmentSlot.SlotType.Chest,
                EquipmentSlot.SlotType.Foot,
                EquipmentSlot.SlotType.Head,
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Fire, Aspect = ModifierGroup.EAspect.Resistance, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .29f, RangeHigh = .31f, DropWeight = 100,
            availableOn = new (){ EquipmentSlot.SlotType.Arm,
                EquipmentSlot.SlotType.Chest,
                EquipmentSlot.SlotType.Foot,
                EquipmentSlot.SlotType.Head,
