...
public class WaterModifiers
{
    List<ModifierGroup> Water_Modifiers = new List<ModifierGroup>()
    {
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Water, Aspect = ModifierGroup.EAspect.Damage, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .10f, RangeHigh = .14f, DropWeight = 9000 },
        new ModifierGroup() { Stat = ModifierGroup.EStat.Water, Aspect = ModifierGroup.EAspect.Damage, Method = ModifierGroup.EMethod.AddPercent, RangeLow = .15f, RangeHigh = .19f, DropWeight = 8000 },
        ...
        new ModifierGroup() { Stat = ModifierGroup.EStat.Water, Aspect = ModifierGroup.EAspect.Damage, Method = ModifierGroup.EMethod.MultiplyPercent, RangeLow = .05f, RangeHigh = .07f, DropWeight = 9000 },
        new ModifierGroup() { Stat = ModifierGroup.EStat.Water, Aspect = ModifierGroup.EAspect.Damage, Method = ModifierGroup.EMethod.MultiplyPercent, RangeLow = .08f, RangeHigh = .10f, DropWeight = 8000 },
